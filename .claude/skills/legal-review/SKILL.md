---
name: legal-review
description: "Run a full contract review using parallel analysis agents, producing a contract safety score, clause-by-clause findings, and prioritized action items. Use when asked to review, analyze, or assess a contract or agreement file end to end."
---
